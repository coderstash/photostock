...
(function() {
    ...
    Ember.RecordArray = Ember.ArrayProxy.extend(Ember.Evented, {
        ...
        loadForFindMany: function(klass) {
            var content = get(this, '_ids')
                .map(function(id) {
                return klass.cachedRecordForId(id);
            });
    ...
    Ember.FilteredRecordArray = Ember.RecordArray.extend({
        ...
        updateFilter: function() {
            var self = this,
                results = [];
            get(this, 'modelClass')
                .forEachCachedRecord(function(record) {
...
(function() {
    ...
    function extractDirty(object, attrsOrRelations, dirtyAttributes) {
        ...
        for (var i = 0, l = attrsOrRelations.length; i < l; i++) {
            ...
            if (descMeta.kind === 'belongsTo' && descMeta.options.embedded !== true && cachedValue instanceof Ember.Model) {
    ...
    Ember.Model.reopenClass({
        ...
        _executeBatch: function() {
            ...
            for (i = 0; i < batchIds.length; i++) {
                if (!this.cachedRecordForId(batchIds[i])
                    .get('isLoaded')) {
            ...
            if (batchIds.length === 1) {
                promise = get(this, 'adapter')
                    .find(this.cachedRecordForId(batchIds[0]), batchIds[0]);
            } else {
                ...
                if (requestIds.length === 0) {
                    ...
                    promise = get(this, 'adapter')
                        .findMany(this, recordArray, requestIds);
                }
            }
        ...
        unregisterRecordArray: function(recordArray) {
            ...
            Ember.A(this.recordArrays)
                .removeObject(recordArray);
        },
    ...
    Ember.belongsTo = function(type, options) {
        ...
        return Ember.computed(function(key, value) {
            ...
            if (arguments.length === 2) {
                if (value) {
                    Ember.assert(Ember.String.fmt('Attempted to set property of type: %@ with a value of type: %@', [value.constructor, type]),
...
(function() {
    ...
    Ember.RESTAdapter = Ember.Adapter.extend({
        ...
        createRecord: function(record) {
            ...
            return this.ajax(url, record.toJSON(), "POST")
                .then(function(data) {
        ...
        saveRecord: function(record) {
            ...
            return this.ajax(url, record.toJSON(), "PUT")
                .then(function(data) { // TODO: Some APIs may or may not return data
        ...
        deleteRecord: function(record) {
            ...
            return this.ajax(url, record.toJSON(), "DELETE")
                .then(function(data) { // TODO: Some APIs may or may not return data
...
(function() {
    ...
    Ember.loadPromise = function(target) {
        if (Ember.isNone(target)) {
            ...
            return Ember.LoadPromise.create({
                target: target
            });
        }
    };
